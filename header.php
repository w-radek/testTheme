...
<html class="no-js" <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <?php $ver = filemtime( get_template_directory() . '/public/css/app.min.css' ); ?>
        <link rel="stylesheet" type="text/css" href="<?php bloginfo( 'template_url' ); ?>/public/css/app.min.css?v=<?php echo $ver; ?>" media="screen"/>
